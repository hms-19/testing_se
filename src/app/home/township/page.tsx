...
const page = () => {
  ...
  const fetchData = async () => {
    await axiosPost(`township/list`,{page, per_page: limit, region_id: inputs.region_id}, (res) => {
      ...
      render: (text: any, record: any, index: number) => {
        return  (
          <ActionCell 
            ...
            isEdit={true} 
            isDelete={true} 
            editLink={'/home/township/edit/'+record.id}
  ...
  return (
    <Box pt={{ base: '130px', md: '80px', xl: '80px' }}>
        <Flex my={'10px'} alignItems={'center'} justifyContent={'space-between'}>
          <TownshipFilter inputs={inputs} setInputs={setInputs} handleSelectChange={handleSelectChange} />
          <AddNewButton link="/home/township/create" />
        </Flex>
